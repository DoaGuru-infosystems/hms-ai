  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (u === "admin" && (p === "admin123" || p === "password")) {
        ...
        (u === "nurse" || u === "nurse1") &&
        (p === "nurse123" || p === "password")
      ) {
        onLogin({
          id: "00009",
          empNo: "EMP-009",
          name: "Sr. Mary D'Souza",
          role: "Nurse",
          token: "mock-jwt-token",
        });
      } else if (
        (u === "receptionist" || u === "receptionist1") &&
        (p === "recep123" || p === "password")
      ) {
        onLogin({
          id: "00010",
          empNo: "EMP-010",
  ...
  return (
    <div className="login-page">
      ...
      <div className="login-card">
        ...
        >
          <div
            style={{ flex: 1, height: 1, background: "var(--surface-border)" }}
          />
          <div
            style={{
              display: "flex",
